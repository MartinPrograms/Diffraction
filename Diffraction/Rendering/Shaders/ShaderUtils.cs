...
public class ShaderUtils
{
    ...
    public static Shader CreateShader(string name,string vertexSource, string fragmentSource)
    {
    ...
    public static void AddShader(Tuple<string,string,string> shader)
    {
        _shaders.Add(shader.Item1, CreateShader(shader.Item1, shader.Item2, shader.Item3));
