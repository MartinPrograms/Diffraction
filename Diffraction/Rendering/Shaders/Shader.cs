...
public class Shader : EventObject
{
    ...
    public Shader(string name, string vertexSource = null, string fragmentSource = null, string computeSource = null)
    {
        Create(name, vertexSource, fragmentSource, computeSource);
    }

    private void Create(string name, string vertexSource, string fragmentSource, string computeSource)
    {
        Name = name;
        ...
        if (_vertexSource != null && _fragmentSource != null)
        {
            _type = ShaderType.Vertex | ShaderType.Fragment;
            Compile();
        }
        else if (_computeSource != null)
        {
    ...
    {
        Create(Name, _vertexLocation, _fragmentLocation, _computeLocation); // Recreate the shader
    }
}
