...
public class LightManager : Object
{
    ...
    public const int MaxLights = 6; // this can only change before the engine starts, and all the shaders need to be recompiled if it does, which is too much of a hassle
