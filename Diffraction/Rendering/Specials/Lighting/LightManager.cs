...
public class LightManager : Object
{
    ...
    public const int MaxLights = 1; // this can only change before the engine starts, and all the shaders need to be recompiled if it does, which is too much of a hassle
    ...
    [ExposeToLua("NormalEnabled")]
    [ShowInEditor]
    public bool NormalEnabled = true;
